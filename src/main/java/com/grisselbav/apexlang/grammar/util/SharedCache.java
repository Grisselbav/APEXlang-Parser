...
import com.grisselbav.apexlang.grammar.ApexLangLexer;
...
public class SharedCache {
    private final ApexLangLexer lexer;
    private final ApexLangParser parser;

    /**
     * Constructor.
     */
    public SharedCache() {
        this.lexer = new ApexLangLexer(CharStreams.fromString(""));
        this.parser = new ApexLangParser(new CommonTokenStream(this.lexer));
    }
     ...
     * Uses reflection to access protected field {@code cache}.
     *
